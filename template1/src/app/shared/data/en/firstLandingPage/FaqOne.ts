export const faqContent = {
    ...
    questions: [
      ...
      },
      {
        ...
        answer: "The free updates that will be provided is based on the <a href='#' class='font-medium underline text-primary-600 hover:no-underline'>roadmap</a> that we have laid out for this project. It is also possible that we will provide extra updates outside of the roadmap as well."
      },
      {
        question: "What does the free version include?",
        answer: "The <a href='#' class='font-medium underline text-primary-600 hover:no-underline'>free version</a> of Windster includes a minimal style guidelines, component variants, and a dashboard page with the mobile version alongside it. You can use this version for any purposes, because it is open-source under the MIT license."
      },
      {
